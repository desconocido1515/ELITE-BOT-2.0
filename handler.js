...
global.dfail = async (type, m, conn, usedPrefix) => {
    let msg = {
        rowner: "¡𝘏𝘰𝘭𝘢 𝘏𝘶𝘮𝘢𝘯𝘰! ✨\n» Este comando solo puede usar mi propietario Kevv.",
        owner: "¡𝘏𝘰𝘭𝘢 𝘏𝘶𝘮𝘢𝘯𝘰! ✨\n» Este comando solo puede usar mi propietario Kevv.",
        mods: "¡𝘏𝘰𝘭𝘢 𝘏𝘶𝘮𝘢𝘯𝘰! ✨\n» Este comando solo puede usar mi propietario Kevv.",
        premium: "🔑 No eres usuario premium. Habla con mi creador.",
        premsubs: 'Esta función solo puede ser usada por subbots premium.', 
        group: "Este comando solo puedes usarlo en grupos.",
        private: "Usa este comando en chat privado.",
        admin: "Este comando solo pueden usar administradores del grupo.",
        botAdmin: "Necesito ser administrador para usar este comando.",
        unreg: "Debes registrarte para usar este comando. Usa .verificar",
        restrict: "Este comando está desactivado por mi creador Kevv."
    }[type]
