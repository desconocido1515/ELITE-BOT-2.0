const handler = async (m, {isOwner, isAdmin, conn, text, participants, args}) => {
  ...
  const countryFlags = {
    ...
    '266': '🇱🇸', '267': '🇧🇼', '268': '🇸🇿', '269': '🇰🇲', '290': '🇸🇭', '291': '🇪🇷', '297': '🇦🇼', '298': '🇫🇴',
    '299': '🇬🇱', '350': '🇬🇮', '351': '🇵🇹', '352': '🇱🇺', '353': '🇮🇪', '354': '🇮🇸', '355': '🇦🇱', '356': '🇲🇹',
    '357': '🇨🇾', '358': '🇫🇮', '359': '🇧🇬', '370': '🇱🇹', '371': '🇱🇻', '372': '🇪🇪', '373': '🇲🇩', '374': '🇦🇲',
    '375': '🇧🇾', '376': '🇦🇩', '377': '🇲🇨', '378': '🇸🇲', '380': '🇺🇦', '381': '🇷🇸', '382': '🇲🇪', '385': '🇭🇷',
    ...
    '852': '🇭🇰', '853': '🇲🇴', '855': '🇰🇭', '856': '🇱🇦', '870': '🇮🇴', '880': '🇧🇩', '886': '🇹🇼', '960': '🇲🇻',
  ...
  const getCountryFlag = (id) => {
    const phoneNumber = id.split('@')[0].replace(/^0+/, '');
    ...
    return '🏳️'; // bandera default si no encuentra
  };
...
handler.help = ['todos'];
handler.tags = ['group'];
handler.command = /^(tagall|invocar|marcar|todo|invocación)$/i;
handler.admin = true;
handler.group = true;
