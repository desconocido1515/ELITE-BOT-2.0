...
para vincularte como *Bot* en esta sesión.
...
`;
let rtx2 = `🔐 *Conexión Bot (Código)*

📲 Usa este código de 8 dígitos para vincularte
como *Bot* en esta sesión.
...
`;
let imagenUrl = 'https://h.uguu.se/BiBjDSvO.jpg';
...
msgRetry,
msgRetryCache,
browser: mcode ? ['Ubuntu', 'Chrome', '110.0.5585.95'] : ['PROYECTOX BETA', 'Chrome','2.0.0'],
version: version,
